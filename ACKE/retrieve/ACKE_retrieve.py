...
class WISE(torch.nn.Module):
    def __init__(self, config, model, device):
        ...
        for layer in self.layers:
            ...
            if type(self.adapter_layers[layer]) is not WISEAdapter:
                setattr(edit_module, layer_name_short, WISEAdapter(config, self.adapter_layers[layer], transpose=transpose))
    ...
    def save(self, save_path):
        ...
        for layer_name in self.layers:
            ...
            if i == 0:
                save_path = "./wise_checkpoint/llama多层save测试27.pt"
            elif i == 1:
                save_path = "./wise_checkpoint/llama多层save测试26.pt"
            elif i == 2:
                save_path = "./wise_checkpoint/llama多层save测试25.pt"
    ...
    def load(self, load_path):
        ...
        for layer_name in self.layers:
            ...
            if i == 0:
                load_path = "./wise_checkpoint/llama多层save测试27.pt"
            elif i == 1:
                load_path = "./wise_checkpoint/llama多层save测试26.pt"
            elif i == 2:
                load_path = "./wise_checkpoint/llama多层save测试25.pt"
        ...
        if self.editing:
            ...
            if globalact.actglo == False:
                ...
                with open ('./nnocheck.txt','a') as file:
                    file.write('new\n')
                    file.close()
                memory_retrieve_weight = self.memory_weight[globalact.actnum]
                print(globalact.actnum)
                layer_out = F.linear(*args, memory_retrieve_weight)
